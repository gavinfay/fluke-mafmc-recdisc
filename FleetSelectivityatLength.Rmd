...
Vectors for Sinatra.CTL from fits  
...
commland <- sigmoidalFitFormula(lenbin.lower, 
                    selplot[[2]]$summaryVector$maximum_y,
                    selplot[[2]]$summaryVector$slope,
                    selplot[[2]]$summaryVector$midPoint_x)
#force to max of 1
...
recland <- sigmoidalFitFormula(lenbin.lower, 
                    selplot[[4]]$summaryVector$maximum_y,
                    selplot[[4]]$summaryVector$slope,
                    selplot[[4]]$summaryVector$midPoint_x)
...
Commercial landings initial selectivity at length:
`r commland1`

Recreational landings initial selectivity at length:
`r recland1`